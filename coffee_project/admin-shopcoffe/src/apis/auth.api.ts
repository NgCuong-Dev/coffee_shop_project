...
export const updateUser = (id: unknown, params?: Omit<BodyUpdateProfile, '_id'>) =>
  http.patch<User>(`/v1/user/update/${id}`, params)
export const getUser = (id: unknown) => http.get<User>(`/user/get-details/${id}`)
export const getAllStaff = (id: unknown) => http.get('/v1/user/get-all-staff')
export const updateStaff = (id: unknown, params?: Omit<BodyUpdateProfile, '_id'>) =>
  http.patch<User>(`/v1/user/${id}`, params)
export const deleteStaff = (id: unknown, params?: Omit<BodyUpdateProfile, '_id'>) => http.delete<User>(`/v1/user/${id}`)
